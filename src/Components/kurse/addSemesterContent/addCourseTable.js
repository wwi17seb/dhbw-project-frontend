  ...
  const createCourseTableRow = () => {
    if (courseTable !== null) {
      ...
      for (var i = 0; i < courseTable['default']['payload']['Presentations'].length; i++) {
        ...
        var kursleistung =
          courseTable['default']['payload']['Presentations'][i]['Lecture']['Module']['AcademicRecords']['abbreviation'];
        var academic_title = courseTable['default']['payload']['Presentations'][i]['lecturers']['academic_title'];
        var lecturer_name =
          courseTable['default']['payload']['Presentations'][i]['lecturers']['firstname'] +
          ' ' +
          courseTable['default']['payload']['Presentations'][i]['lecturers']['lastname'];
